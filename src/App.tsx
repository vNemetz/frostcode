...
const App = () => {
  return (
      <div className="min-h-screen w-full">
        {/* Navbar content */}
        <div className=" bg-[#499ed6] w-full flex items-center justify-between p-2 fixed z-[2]">
          <div
          ...
          <div className="ml-[45rem] mr-0 flex bg-[#14214d] text-white rounded-2xl">
            <input
              placeholder="Search"
              className="w-[15rem] py-1 text-left pl-[5px] bg-[#2e7aac]
            focus:outline-none rounded-l-2xl
            transition-colors duration-200 italic focus:not-italic"
            />
            <button className="px-3 py-1 bg-[#2e7aac] rounded-r-2xl hover:cursor-pointer hover:bg-[#8bc5ff]">
              <FaSearch className="" />
            </button>
          </div>
        ...
        <div className="block pt-[4rem]">
          ...
          >
            <div className="font-inter w-[90vw] h-[80vh] rounded-3xl flex align-center flex-col items-center text-black">
